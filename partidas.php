    ...
    <div class="site-wrap">
        ...
        <div class="site-section site-blocks-vs">
            <div class="container">
                ...
                $response = $api->findMatchesByCompetitionAndMatchday(2013, 1);
                ?>
                        ...
                        ?>
                            <div class="row bg-white align-items-center ml-0 mr-0 py-4 match-entry">
                                <div class="col-md-4 col-lg-4 mb-4 mb-lg-0">
                                    ...
                                    <div class="text-center text-lg-left">
                                        <div class="d-block d-lg-flex align-items-center">
                                            ...
                                            <div class="text">
                                                <h3 class="h5 mb-0 text-black"><?php echo $match->homeTeam->name; ?></h3>
                                ...
                                <div class="col-md-4 col-lg-4 text-center mb-4 mb-lg-0">
                                    <div class="d-inline-block">
                                        <div class="bg-black py-2 px-4 mb-2 text-white d-inline-block rounded"><span class="h5"><?php echo $match->score->fullTime->homeTeam; ?>:<?php echo $match->score->fullTime->awayTeam; ?></span></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="">
                                        <div class="d-block d-lg-flex align-items-center">
                                            ...
                                            <div class="text order-1 w-100">
                                                <h3 class="h5 mb-0 text-black"><?php echo $match->awayTeam->name; ?></h3>
